...
const PokemonCard = ({ id, name, types, image }) => {
  return (
    <div className="bg-white border-4 border-slate-900 rounded-lg p-3 flex flex-col gap-3 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer group">
